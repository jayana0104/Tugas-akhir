...
<html>
<head>
	<title>Sistem Informasi Pemesanan Kamar Pada Hotel J&J</title>
	<meta charset="utf-8">
...
<body>
	<nav>
			<img src="../gambar/J&J.webp" width="100px"> <span style="float: right; margin-right: 80px;"><center><img src="../simpangambar/<?php 
				if ($foto != '') {
					echo $foto;
				}
				else {
			...
			?>" width="50px" height="50px"><p style="text-transform:uppercase;font-weight: bold;color: white;">&nbsp;&nbsp;<?php echo $nama; ?></p><li style="list-style: none;float: left;"><a href="profil" id="tomboll" style="padding:3px;border:1px solid white;">Profil</a></li>
